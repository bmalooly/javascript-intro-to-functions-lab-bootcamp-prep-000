...
function sayHitoGrandma(string) if(string.toLowerCase)() {return ("I can/'t hear you!")} else if(string.toUpperCase === string) {return("YES INDEED!")} else(string==="I love you, Grandma."{return("I love you, too"))}